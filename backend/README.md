...
## Project Structure
    ...
    ├── elicaproductinfo_37362  # Django project configurations
...
1. Clone this repo and `cd elicaproductinfo_37362`
...
2. Clone this repo and `cd elicaproductinfo_37362`
